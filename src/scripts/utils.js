...
function getAlphabet() {
  ...
  */
  ...
  export { splitExtASCIIstring, decale, hexaToDecimal, getExtendedAsciiCodeOf, getExtendedAsciiCharOf, indexOf, getAlphabet, getNumbers, getRandomInt, splitToNblocs };