...
import { encrypt, decrypt } from "./../../../scripts/Vigenere";
...
export default function VigenereForm({ data, text, onTextChange, onResult }) {
  ...
  const handleKeyChange = e => {
    ...
    setKey(value);
    const regex = /^[a-zA-Z]+$/gi; // lettre majuscules et minuscules uniquement
